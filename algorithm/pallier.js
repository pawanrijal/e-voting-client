...
export const generateRandomKeys = function (bitLength = 2048, simplevariant = false) {
...
export const PaillierPublicKey = class PaillierPublicKey {
    constructor(n, g) {
        this.n = bigInt(n);
...
export const PaillierPrivateKey = class PaillierPrivateKey {
